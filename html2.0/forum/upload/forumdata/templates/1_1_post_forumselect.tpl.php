...
<em>Navigation</em>
<span>
<? if(!empty($infloat)) { ?><a href="javascript:;" class="float_close" onclick="hideWindow('nav')" title="Close">Close</a><? } ?>
</span>
</h3>
<div class="postbox">
<p class="s_clear">
<button class="right" id="postbtn" onclick="hideWindow('nav');showWindow('newthread', 'post.php?action=newthread&fid=' + selectfid);" disabled="disabled">New</button>
<button class="right" id="enterbtn" onclick="locationforums(currentblock, currentfid)" disabled="disabled">Enter</button>
...
var s = '<p><a id="commonforum" href="javascript:;" onclick="switchforums(this, 1, \'common\')" class="hassubboard lightlink">Common Forum</a></p>';
