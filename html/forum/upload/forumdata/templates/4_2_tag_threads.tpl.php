...
0
|| checktplrefresh('/var/www/html/forum/upload/./templates/default/tag_threads.htm', '/var/www/html/forum/upload/./templates/default/header.htm', 1379321267, '2', './templates/colors')
|| checktplrefresh('/var/www/html/forum/upload/./templates/default/tag_threads.htm', '/var/www/html/forum/upload/./templates/default/footer.htm', 1379321267, '2', './templates/colors')
|| checktplrefresh('/var/www/html/forum/upload/./templates/default/tag_threads.htm', '/var/www/html/forum/upload/./templates/default/jsmenu.htm', 1379321267, '2', './templates/colors')
;?>
<? if($inajax) { include template('header', '0', ''); ?><div class="tagthread">
<a class="close deloption" href="javascript:;" onclick="hideMenu()" title="Close"><img src="<?=IMGDIR?>/close.gif" alt="Close" /></a>
<h4>Tag: <?=$name?></h4>
<span id="tagpage_0">
<ul>
...
<li class="more"><a href="tag.php?name=<?=$tagnameenc?>" target="_blank">More Tags</a></li>
</ul>
</span>
...
<div id="nav">
<a href="<?=$indexname?>"><?=$bbname?></a> &raquo; <a href="tag.php">Tag</a> &raquo; <?=$name?>
</div>
...
<img src="<?=IMGDIR?>/pin_<?=$thread['displayorder']?>.gif" alt="Stick<? if($thread['displayorder'] == 3) { ?><?=$threadsticky['0']?><? } elseif($thread['displayorder'] == 2) { ?><?=$threadsticky['1']?><? } elseif($thread['displayorder'] == 1) { ?><?=$threadsticky['2']?><? } ?>" />
<? } if($thread['digest']) { ?>
...
<tr><td colspan="4">Tag Not Found</td></tr>
<? } ?>
</tbody>
</table>
