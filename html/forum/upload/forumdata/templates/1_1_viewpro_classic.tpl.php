...
0
|| checktplrefresh('/var/www/html/forum/upload/././templates/default/viewpro_classic.htm', '/var/www/html/forum/upload/././templates/default/header.htm', 1378780758, '1', './templates/default')
|| checktplrefresh('/var/www/html/forum/upload/././templates/default/viewpro_classic.htm', '/var/www/html/forum/upload/././templates/default/footer.htm', 1378780758, '1', './templates/default')
|| checktplrefresh('/var/www/html/forum/upload/././templates/default/viewpro_classic.htm', '/var/www/html/forum/upload/././templates/default/jsmenu.htm', 1378780758, '1', './templates/default')
;?>
...
<?=$pluginhooks['global_header']?><div id="nav"><a href="<?=$indexname?>"><?=$bbname?></a> &raquo; <? if($discuz_uid == $member['uid']) { ?>My Profile<? } else { ?><?=$member['username']?>'s profile<? } ?></div>
