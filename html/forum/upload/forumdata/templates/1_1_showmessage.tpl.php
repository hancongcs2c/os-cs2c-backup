...
0
|| checktplrefresh('/var/www/html/forum/upload/././templates/default/showmessage.htm', '/var/www/html/forum/upload/././templates/default/header.htm', 1378780604, '1', './templates/default')
|| checktplrefresh('/var/www/html/forum/upload/././templates/default/showmessage.htm', '/var/www/html/forum/upload/././templates/default/footer.htm', 1378780604, '1', './templates/default')
|| checktplrefresh('/var/www/html/forum/upload/././templates/default/showmessage.htm', '/var/www/html/forum/upload/././templates/default/jsmenu.htm', 1378780604, '1', './templates/default')
;?>
...
<?=$pluginhooks['global_header']?><? } else { include template('header_ajax', '0', ''); } $allowreturn = $url_forward || !stristr($show_message, 'Return') ? 0 : 1;$alerttype = $url_forward ? (preg_match('/\_succeed$/', $message) ? 'alert_right' : 'alert_info') : ($allowreturn ? 'alert_error' : 'alert_info'); if(!$inajax) { ?>
